...
* **Соблюдение лимитов API** — не чаще одного запроса в 3 секунды, повтор при 429 и таймаутах, без повтора собственных 4xx.
